...
Calculation of the fuel consumption Decembaer 07
```{r}
...
Using median filter to the data.
...
plot(x,y_golay,xaxt="n", type= "l",col="green")
#lines ( x, y_fixed)
axis.POSIXct(1,at=x,labels=format(x,"%d-%H:%M"),las=2)

```

filtering over the fixed data

```{r}

y_f_golay <- sgolayfilt(y_fixed,p = 1, n= 25)
plot(x,y_f_golay,xaxt="n", type= "l",col="green")
#lines ( x, y_fixed)
axis.POSIXct(1,at=x,labels=format(x,"%d-%H:%M"),las=2)
